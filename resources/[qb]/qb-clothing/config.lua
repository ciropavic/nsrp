...
Config.ClothingRooms = {
    ...
    [4] = {requiredJob = "realestate", isGang = false, coords = vector3(-131.45, -633.74, 168.82), width = 2, length = 2, cameraLocation = vector4(-131.45, -633.74, 168.82,  2.18)},
    [5] = {requiredJob = "ambulance", isGang = false, coords = vector3(-255.85, 6326.9, 32.43), width = 2, length = 2, cameraLocation = vector4(-256.64, 6327.01, 32.43, 324.79)},
}
