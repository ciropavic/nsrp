...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
        ...
        [2] = vector3(339.91, -586.14, 28.79),
    },
    ["duty"] = {
        [1] = vector3(339.39, -581.48, 28.79),
        [2] = vector3(323.55, -582.18, 43.32), 
        -- Paleto
        [3] = vector3(-260.93, 6311.29, 32.43),
    },
    ["vehicle"] = {
        [1] = vector4(327.35, -557.41, 28.74, 241.88),
        [2] = vector4(359.08, -607.88, 28.68, 193.23), 
        -- Paleto
        [3] = vector4(-258.22, 6346.93, 32.43, 321.87),
    },
    ["helicopter"] = {
    },
    ["armory"] = {
        [1] = vector3(332.39, -581.48, 28.79),
        [2] = vector3(310.02, -602.67, 43.29),
        -- Paleto
        [3] = vector3(-258.4, 6325.84, 32.43),
    },
    ["roof"] = {
    },
    ["main"] = {
    ...
    ["stash"] = {
        [1] = vector3(335.3649, -585.8517, 28.7915),
    },
    ["beds"] = {
    ...
    -- Bottom Pill Box
        [12] = {coords = vector4(354.12, -562.15, 29.72, 160.43),taken = false, model = 1631638868},
        [13] = {coords = vector4(357.67, -563.51, 29.72, 163.66), taken = false, model = 1631638868},
        [14] = {coords = vector4(360.99, -564.7, 29.72, 157.69), taken = false, model = 1631638868},
        [15] = {coords = vector4(351.97, -568.52, 29.72, 342.73), taken = false, model = 2117668672},
        [16] = {coords = vector4(355.32, -569.57, 29.72, 327.78), taken = false, model = 2117668672},
        [17] = {coords = vector4(358.8, -570.96, 29.72, 351.05), taken = false, model = 2117668672},
        [18] = {coords = vector4(364.71, -571.85, 29.5, 74.27), taken = false, model = 1631638868},
        [19] = {coords = vector4(366.46, -568.09, 29.5, 73.84), taken = false, model = 1631638868},
...
Config.AuthorizedVehicles = { -- Vehicles players can use based on their ambulance job grade level
    ...
    [2] = {
        ["lsambulance"] = "Ambulance",
        ["ambulance22"] = "Ambulance Advanced",
        ["f750"] = "F750 Ambulance",
    },
    [3] = {
        ["lsambulance"] = "Ambulance",
