...
local function VehicleTheft(vehicle)  
    ...
    TriggerServerEvent("dispatch:server:notify", {
        dispatchcodename = "vehicletheft", -- has to match the codtrfes in sv_dispatchcodes.lua so that it generates the right blip
        dispatchCode = "10-35",
...
exports('VehicleTheft', VehicleTheft) -- IN SERVER
...
local function InjuriedPerson()
    ...
    TriggerServerEvent("dispatch:server:notify", {
        ...
        dispatchMessage = "Civilian Injured", -- message
        job = { "ambulance" } -- jobs that will get the alerts
    })
end

exports('InjuriedPerson', InjuriedPerson) -- INSERVER 
...
exports('CarJacking', CarJacking) -- IN SERVER
